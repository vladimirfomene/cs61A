...
class Fib():
    ...
    def next(self):
        if self.value == 0:
            ...
            return Fib(self.value + 1)
        else:
            tmp = Fib.previous + self.value
            Fib.previous = self.value
            return Fib(tmp)
...
class VendingMachine:
    ...
    'Here is your soda.'
    """
    def __init__(self, product, price, cash = 0, stock = 0):
    ...
    def vend(self):
        if self.stock == 0:
            ...
            self.cash = 0
            self.stock -= 1
            return 'Here is your {0} and ${1} change.'.format(self.product, temp)
