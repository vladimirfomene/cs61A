...
def distance(city1, city2):
    ...
    5.0
    """
    return sqrt((city1.get_lat() - city1.get_lat())**2 + (city1.get_lon() - city2.get_lon())**2)
...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    #create a temporal city
    tmp_city = make_city('Temporal', lat, lon)
    dist_one = distance(tmp_city, city1)
    dist_two = distance(tmp_city, city2)
